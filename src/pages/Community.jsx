      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto pb-24">
          ...
          <div className="grid grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden">
            {[
              ...
              <div key={i} className="bg-[#0F172A] hover:bg-white/5 transition-colors p-8 text-center">
                ...
                <p className={`font-heading font-black text-4xl ${item.color} mb-2`}>
                  {loading ? "..." : item.value}
                </p>
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-orange-400 font-heading font-semibold text-sm uppercase tracking-widest">Community Poll</span>
          </div>
          <CommunityPoll />
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-orange-400 font-heading font-semibold text-sm uppercase tracking-widest">Quiz Results</span>
          </div>
